 ...
 * @author user
 */
public class Silver_Membership extends Membership{
    private double memberDiscount = 5.0;
    private int MonthlyGiftRedemption = 3;
    private double extraMemberPoint = 1.5;
    
    public Silver_Membership () {
        
    }
    
    public Silver_Membership (Member member, String memberStatus) {
    ...
    @Override
    public Silver_Membership createMember (int ID, String type){
        ...
        int age = 0;
            ...
            Silver_Membership newmember = new Silver_Membership (new Member (ID, name , age, contact , gender), type);
