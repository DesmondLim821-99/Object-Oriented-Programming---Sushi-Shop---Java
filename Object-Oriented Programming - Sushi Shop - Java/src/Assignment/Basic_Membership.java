 ...
 * @author user
 */
public class Basic_Membership extends Membership {
    private double memberDiscount = 2.5;
    private int MonthlyGiftRedemption = 3;
    
    public Basic_Membership (){
        
    }
    
    public Basic_Membership (Member member, String memberStatus){
    ...
    public int getMonthlyGiftRedemption (){
        return MonthlyGiftRedemption;
    }
    
    @Override
    public Basic_Membership createMember (int ID, String type){
        ...
        int age = 0;
            ...
            Basic_Membership newmember = new Basic_Membership (new Member (ID, name , age, contact , gender), type);
